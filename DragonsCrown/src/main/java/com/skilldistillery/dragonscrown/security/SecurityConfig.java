...
public class SecurityConfig {
    ...
    public SecurityFilterChain createFilterChain(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET, "/api/classes").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/classes/*").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/classStats").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/classStats/*").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/recommendations").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/recommendations/*").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/stat-scalings").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/stat-scalings/*").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/skills").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/skills/*").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/quests").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/quests/*").permitAll()  // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/proxy/image").permitAll()
