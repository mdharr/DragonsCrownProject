...
START TRANSACTION;
USE `dragonscrowndb`;
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (1, 'Slide Attack', 'Increased chance of taking enemy down\nwhen sliding (Down + Square).', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/003.jpg', 1, NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (2, 'Wealth to Health', 'Recover HP when picking up coins.', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/004.jpg', 1, NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (3, 'Money is Power', 'Picking up coins adds to your score.', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/005.jpg', 1, NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (4, 'Vitality Boost', 'Increases your max HP.', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/006.jpg', 1, NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (5, 'Nutritionist', 'Increases the healing effectiveness of food.', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/007.jpg', 1, NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (6, 'Maintenance', 'Grants a chance that using a temporary weapon won\'t decrease its number of uses.', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/008.jpg', 1, NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (7, 'Adroit Hands', 'Reduces cooldown time in between using items.', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/009.jpg', 1, NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (8, 'Evasion', 'Increases the number of times you can evade.', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/010.jpg', 1, NULL);
INSERT INTO `skill` (`id`, `name`, `description`, `card_image_url`, `is_common`, `category`) VALUES (9, 'Deep Pockets', 'Increases the number of slots in Bags.', 'https://www.4gamer.net/games/134/G013480/FC20130711001/TN/011.jpg', 1, NULL);
